                    ...
                    <div>
                        ...
                        <div>
                            <motion.div
                                ...
                                transition={{ duration: 1, delay: 0.5 }}
                            >
                                <p className="mt-5 text-3xl font-bold text-center">Kamal Saluja</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
                    ...
                    <div>
                        ...
                        <div>
                            <motion.div
                                ...
                                transition={{ duration: 1, delay: 0.5 }}
                            >
                                <p className="mt-5 text-3xl font-bold text-center">Lekha Rani</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
                    ...
                    <div>
                        ...
                        <div>
                            <motion.div
                                ...
                                transition={{ duration: 1, delay: 0.5 }}
                            >
                                <p className="mt-5 text-3xl font-bold text-center">Animesh Kumar</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
                    ...
                    <div>
                        ...
                        <div>
                            <motion.div
                                ...
                                transition={{ duration: 1, delay: 0.5 }}
                            >
                                <p className="mt-5 text-3xl font-bold text-center">Preenu Mittan</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, x: -20 }}
                                animate={{ opacity: 1, x: 0 }}
