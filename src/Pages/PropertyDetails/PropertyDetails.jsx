...
const PropertyDetails = () => {
    ...
    return (
        <div>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Apartment GURU | All Properties | Property Details</title>
            </Helmet>


            <div className="container mx-auto px-5 my-10">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="flex flex-col lg:flex-row rounded-xl shadow-xl lg:col-span-2">
                                    ...
                                    <div className="modal-box w-11/12 max-w-5xl">
                                        ...
                                        <form onSubmit={handleAddReview}>
                                            ...
                                            <div>
                                                ...
                                                <div  className="flex flex-col md:flex-row border border-[#03a9fc] rounded-xl mt-5">
            ...
            <div className="container mx-auto px-5">
                <h2  className="text-3xl font-bold text-center mt-14 mb-7">{propertyTitle} <br /> All Reviews</h2>

                

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10 mb-10">
                    {
                        review.map(review => <div key={review._id} className=" border-[#03a9fc] p-7 rounded-xl " style={{ borderWidth: '2px' }}>
