...
const Login = () => {
    ...
    return (
        <div>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Apartment GURU | Login</title>
            </Helmet>
            <div className="flex justify-center my-12 container mx-auto px-5 py-10">
                <div className="border rounded-xl w-full md:w-3/4 lg:w-2/4 py-8">
                    <h2 className="text-3xl font-bold text-center pt-10 pb-5"><span className="text-[]">Login</span> <span className="">your account</span></h2>
