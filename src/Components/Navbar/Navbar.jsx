...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
            ...
            user ? <>
                <li>
                    <NavLink to='/' className={({ isActive, isPending }) =>
                        isPending ? "pending" : isActive ? "font-bold text-[#ffffff] " : ""
                    }>Home</NavLink>
                </li>
                <li>
    ...
    return (
        <div className="bg-base-100" style={{backgroundColor: '#03a9fc'}}>
            <div className="navbar container mx-auto px-5 py-5">
                <div className="navbar-start">
                    ...
                    <div className="flex gap-1">
                        ...
                        <div className="flex items-center">
                            <p className="text-sm md:text-2xl font-bold text-[#ffffff]">Apartment <span className="text-[#ffffff]">GURU</span></p>
                        </div>
                    </div>
                </div>
